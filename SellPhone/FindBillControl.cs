...
namespace SellPhone
{
    public partial class FindBillControl : UserControl
    {
        ...
        private void findBtn_Click(object sender, EventArgs e)
        {
            ...
            if (checkBoxDay.Checked)
            {
                comm = new SqlCommand("LocHoaDon_TheoNgay", DBConnecttion.conn);
            ...
            {
                comm = new SqlCommand("LocHoaDon_TheoThang", DBConnecttion.conn);
                comm.CommandType = CommandType.StoredProcedure;
            ...
            {
                comm = new SqlCommand("LocHoaDon_TheoQuy", DBConnecttion.conn);
                comm.CommandType = CommandType.StoredProcedure;
                int quy = 1;
            ...
            {
                comm = new SqlCommand("LocHoaDon_TheoNam", DBConnecttion.conn);
                comm.CommandType = CommandType.StoredProcedure;
                comm.Parameters.Add(new SqlParameter("@Nam", SqlDbType.Int));
                comm.Parameters["@Nam"].Value = yearInp.Text;
            }
        ...
        {
            HDReport hDReport = new HDReport();
            hDReport.ShowDialog();  
        }
    }
}
